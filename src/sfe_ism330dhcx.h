...
public:
	...
	/**
	 * @brief      Called to init the system. Connects to the device and sets it
	 *             up for operation
	 *
	...
	/**
	 * @brief      Reads a register region.
	 *
	 * @param[in]  reg     The register to read from
	 * @param[ou]  data    The data
	...
	/**
	 * @brief      Sets the communication bus.
	 *
	 * @param      theBus      The Bus object to use
	 * @param[in]  i2cAddress  The bus i2c address of the target device.
	 */
